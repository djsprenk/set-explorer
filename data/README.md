...
- `processed-files` holds processed files from both intermediate and completed data transforms.

## VirtualDJ Database Dump

In VirtualDJ, create a database backup ([example](https://drive.google.com/drive/folders/1nLHNQm0gL-9LhUPKAxalmOWcFksMBcvI)). This is a .ZIP file which needs to be unpacked and the contents moved into `data/vdj-database`.
